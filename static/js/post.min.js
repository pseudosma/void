...
function scaleElements(e){commonScaleElements(e),window.scrollTo(0,0);const t=window.innerWidth,n=document.getElementById("title"),l=document.getElementById("animated-title"),i=document.getElementById("text");n.style.left=0,l.style.left=0,n.style.top="90px",l.style.top="90px",n.style.fontSize="24px",l.style.fontSize="24px",i.style.fontSize="14pt",t>700&&(n.style.fontSize="36px",l.style.fontSize="36px"),t>1800&&(n.style.fontSize="48px",l.style.fontSize="48px",i.style.fontSize="24pt");const o=n.getBoundingClientRect(),s=t/2-o.width/2;n.style.left=s+"px",l.style.left=s+"px",i.style.marginTop=o.bottom+20+"px",i.style.maxWidth=t>950?"85%":"90%"}function load(){scaleElements(!0),document.getElementById("post-title-wrapper").style.visibility="visible",document.getElementById("text").style.visibility="visible",document.getElementById("menu-wrapper").style.visibility="visible",commonLoad()}function playPause(){const e=document.getElementById("animated-title");isPlaying?animate(e,"none"):animate(e,titleAnimation),commonPlayPause()}window.onload=load,window.addEventListener("resize",(()=>{scaleElements(!1)}));
